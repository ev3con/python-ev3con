...
if __name__ == "__main__":
    ...
    broadcast = netifaces.ifaddresses("wlan0")[netifaces.AF_INET][0]["broadcast"]
    ...
    try:
        ...
        while True:
            ...
            if mesg[0] == "STOP" and p.name == "follow_line":
            ...
            elif mesg[0] == "START" and p.name == "wait":
                sock.sendto("ACK", (addr[0],5005))
                p.terminate()
                p = Process(name="follow_line", target=follow_line, args=follow_line_args)
                p.start()
